...
- **About Section** — Personal introduction + profile image  
- **Projects Section** — Cards showcasing real-world projects  
- **Skills Section** — Tech stack visually presented  
- **Contact Section** — Easy navigation to contact/social profiles  
- **Interactive Robot** — Hover/click animations built with React  
- **Downloadable Resume** — PDF downloaded directly from the site  
